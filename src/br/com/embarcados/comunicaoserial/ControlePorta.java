...
public class ControlePorta {
	...
	private void initialize() {
		try {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Porta COM não encontrada.", "Porta COM",
	...
	public void close() {
		try {
			...
			JOptionPane.showMessageDialog(null, "Não foi possível fechar porta COM.", "Fechar porta COM",
					JOptionPane.PLAIN_MESSAGE);
		}
	}
	...
	public void enviaDados(String opcao) {
		...
		try {
			serialOut.write(dados);// escreve o valor na porta serial para ser
									// enviado
		} catch (IOException ex) {
			JOptionPane.showMessageDialog(null, "Não foi possível enviar o dado. ", "Enviar dados",
					JOptionPane.PLAIN_MESSAGE);
